...
import { SafetyCertificateOutlined, SyncOutlined, RocketOutlined } from '@ant-design/icons';
    ...
    return <>
        <div className={classes['home']}>
            <div className={classes['carousels']}>
                <Carousel autoplay autoplaySpeed={3000} style={{height: '830px'}}>
                    {carouselImages.map((image, index) => (
                        <div key={index} className={classes['image-container']}>
                            <img src={image.src} alt={`car`} />
                            <h1>Rent A Car</h1>
                            <p>Unlock Your Journey: Rent. Drive. Explore.</p>
                        </div>
                    ))}
                </Carousel>
            </div>
